			       ...
			       struct stream *s)
{
	...
	if (router_cap->srv6.enabled) {
		...
		if (router_cap->srv6.max_seg_left_msd +
			...
			stream_putc(s, 0); /* Put 0 as Sub-TLV length for now */
