		      ...
		      void *gate, afi_t afi, vrf_id_t vrf_id)
{
	...
	if (seg6l_flv.flv_op != ZEBRA_SEG6_LOCAL_FLV_OP_UNSPEC) {
		if (seg6l_flv.lcblock_len == 0)
			seg6l_flv.lcblock_len = ZEBRA_DEFAULT_SEG6_LOCAL_FLV_LCBLOCK_LEN;
		if (seg6l_flv.lcnode_func_len == 0)
			seg6l_flv.lcnode_func_len = ZEBRA_DEFAULT_SEG6_LOCAL_FLV_LCNODE_FN_LEN;
	}
