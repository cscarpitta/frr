...
def test_srv6_usid_locator_get_chunk():
    ...
    logger.info("Get chunk for the locator loc2")
    router.vtysh_cmd("sharp srv6-manager get-locator-chunk loc2")
...
def test_srv6_usid_locator_release_chunk():
    ...
    router.vtysh_cmd("sharp srv6-manager release-locator-chunk loc2")
...
def test_srv6_usid_locator_set_behavior_usid():
    ...
    logger.info(
        "Specify the SRv6 Locator loc3 as a Micro-segment (uSID) Locator"
    )
    router.vtysh_cmd(
        """
        configure terminal
...
def test_srv6_usid_locator_unset_behavior_usid():
    ...
    logger.info("Clear Micro-segment (uSID) Locator flag for loc3")
    router.vtysh_cmd(
        """
        configure terminal
         segment-routing
...
def test_srv6_usid_locator_delete():
    ...
    logger.info(
        "Delete locator loc2 and verify that the chunk is released automatically"
    )
    router.vtysh_cmd(
        """
        configure terminal
